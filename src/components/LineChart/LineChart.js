...
const LineChart = ({ crime, chartData }) => {
  ...
  return (
    <div className="w-full border print:border-none p-1 print:p-0 print:shadow-none shadow-md rounded-md">
      ...
      <div className="w-full flex flex-col bg-[#F2F4F5] rounded-[12px] overflow-hidden">
        <div className="w-full h-[1.5rem] flex-none flex items-center justify-start p-[7px] bg-[#E8EEFB]">
          <span className='text-[9px] font-[500] text-[#1463FF]'>{crime ? crime : ''}</span>
        </div>
        <div className='px-[1.5rem] relative py-[1rem]'>
          <div className='rotate-[270deg] text-[9px] font-[500] absolute -left-[0] top-1/2 -translate-y-1/2 text-black'>Arrests</div>
          <div className='w-full bg-white rounded-[12px] overflow-hidden p-[.5rem]' style={{ maxWidth: '100%', height: '151px', margin: '0 auto' }}>
